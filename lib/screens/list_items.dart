...
import 'dart:convert';
import 'package:flutter_devandra/models/product.dart';
...
Future<List<Items>> fetchProduct() async {
    ...
    var url = Uri.parse(
        'https://devandra-reswara-tugas.pbp.cs.ui.ac.id/json/');
    ...
    List<Items> list_product = [];
    for (var d in data) {
        if (d != null) {
            list_product.add(Items.fromJson(d));
        }
    }
    return list_product;
}
